...
import { CalculatorSolution } from "@/src/components/solutions";

// -------------------------------------------------------------------------
// 🏗️ USER WORKSPACE
// -------------------------------------------------------------------------

function CalculatorWorkshop() {
  return (
    <div className="w-full max-w-md bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-800">
      <div className="text-center text-zinc-500 py-12 border-2 border-dashed border-zinc-200 dark:border-zinc-700 rounded-lg">
        <p>🚧 Tu calculadora aparecerá aquí 🚧</p>
...
export default function CalculatorPage() {
  const { t } = useLanguage();
  const c = t.projects.list.calculator;
  ...
  return (
    <ChallengeLayout
      ...
      hints={c.hints || []}
      solution={c.solution}
      solutionComponent={<CalculatorSolution />}
